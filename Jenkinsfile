...
//        e.g https://github.com/abdul317/events-app-web-server might become https://github.com/MyName/external.git
...
//      https://github.com/abdul317/events-app-web-server
//      mydockerid0000001
//      api-server-image
//      cnd-events-cluster 
//      us-east-1  
...
pipeline {
   ...
   environment {
        ...
        imageName = 'mydockerid0000001/api-server-image'
        dockerImage = ''
        }
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/abdul317/events-app-web-server'
        ...
        stage('Building image') {
         ...
         stage('update k8s') {
            ...
            steps {
                echo 'Set the image'
                     sh "kubectl -n user14 set image deployment/demo-api demo-api=${env.imageName}:${env.BUILD_NUMBER} --kubeconfig=${WORKSPACE}/.kube/config"
            }
        }     
